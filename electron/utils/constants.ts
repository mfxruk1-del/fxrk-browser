...
export const APP_NAME = 'FXRK Browser'
export const APP_ID = 'com.fxrk.browser'

// User data paths
export const USER_DATA_PATH = app?.getPath('userData') || path.join(process.env.APPDATA || '', 'fxrk-browser')
export const DB_PATH = path.join(USER_DATA_PATH, 'fxrk.db')
export const LOG_PATH = path.join(USER_DATA_PATH, 'logs')
export const DOWNLOADS_PATH = app?.getPath('downloads') || path.join(process.env.USERPROFILE || '', 'Downloads')
export const BACKUP_PATH = path.join(USER_DATA_PATH, 'backups')
export const FILTER_LISTS_PATH = path.join(USER_DATA_PATH, 'filter-lists')
export const SESSIONS_PATH = path.join(USER_DATA_PATH, 'sessions')
export const SCREENSHOTS_PATH = path.join(USER_DATA_PATH, 'screenshots')
...
export const DEFAULT_HOME_PAGE = 'fxrk://newtab'
export const NEW_TAB_URL = 'fxrk://newtab'
export const SETTINGS_URL = 'fxrk://settings'

// Encryption
export const ENCRYPTION_KEY_ITERATIONS = 10000
export const ENCRYPTION_KEY_SIZE = 256

// Session auto-save interval (5 minutes)
export const SESSION_SAVE_INTERVAL = 5 * 60 * 1000

// Auto-lock database after 15 minutes
export const AUTO_LOCK_TIMEOUT = 15 * 60 * 1000

// Filter list update interval (7 days)
export const FILTER_UPDATE_INTERVAL = 7 * 24 * 60 * 60 * 1000

// Phone bridge poll interval (fallback, 30 seconds)
export const PHONE_POLL_INTERVAL = 30 * 1000

// Clipboard sync check interval (60 seconds)
export const CLIPBOARD_SYNC_INTERVAL = 60 * 1000

// iCloud URLs
export const ICLOUD_URLS = {
...
export const DEFAULT_SPEED_DIAL = [
